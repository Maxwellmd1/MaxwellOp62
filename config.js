...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/a1f712400b07d9193c5da.jpg" ; // SET LOGO FOR IMAGE 
global.caption = process.env.CAPTION || global.caption || "𝙀𝙣𝙖𝙗𝙡𝙚𝙙 𝘽𝙮 𖣘𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫♡● " 
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2349120730021,923xxxxxxxx";
...
module.exports = {
  ...
  LANG: ( process.env.THEME ||  "𝑴𝑨𝑿𝑾𝑬𝑳𝑳"  ).toUpperCase(),
